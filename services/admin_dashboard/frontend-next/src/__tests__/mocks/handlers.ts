...
export const mockReleases = [
  {
    ...
    status: 'completed',
    release_type: 'minor',
    target_date: '2024-03-01T10:00:00Z',
    created_at: '2024-02-15T00:00:00Z',
  ...
  },
  {
    ...
    status: 'in_progress',
    release_type: 'minor',
    target_date: '2024-03-15T10:00:00Z',
  ...
  },
  {
    ...
    status: 'planned',
    release_type: 'major',
    target_date: '2024-06-01T10:00:00Z',
  ...
  },
  {
    ...
    status: 'in_progress',
    release_type: 'patch',
    target_date: '2024-03-08T14:00:00Z',
...
export const mockFeatureRequests = [
  {
    ...
    status: 'triaged',  // Updated to match backend enum
    priority: 'high',
  ...
  },
  {
    ...
    status: 'in_progress',  // Stays the same
    priority: 'medium',
  ...
  },
  {
    ...
    status: 'submitted',  // Updated: pending → submitted
    priority: 'high',
  ...
  },
  {
    ...
    status: 'rejected',  // Stays the same
    priority: 'low',
...
`);
  ...
  http.post(`${API_URL}/feature-requests`, async ({ request }) => {
    ...
    const newFr = {
      id: 'fr-' + Date.now(),
      ...body,
      status: 'submitted',  // New requests start as submitted
      votes: 0,
      comments: 0,
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
